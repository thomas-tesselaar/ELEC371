...
#ifndef _LEDS_H_
#define _LEDS_H_ ((volatile unsigned int *) 0x10000020)
...
void Init (void)
{
	...
	*_LEDS_H_ = 0x40404040;
	...
	NIOS2_WRITE_IENABLE(0x1C000); // enables IRQ 0, our timer
...
void handleTimer2()
{
	if ((*SWITCHES & 0x4) == 0x4)
	{
		if (*_LEDS_H_ == 0x01010101 || *_LEDS_H_ == 0x08080808)
		{
			*_LEDS_H_ = 0x40404040;
			dir = dir ^ 1;
		}
